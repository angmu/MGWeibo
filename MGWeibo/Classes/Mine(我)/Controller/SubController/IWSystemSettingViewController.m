...
- (void)setupFooter
{
    ...
    // 背景和文字
    [logoutButton setBackgroundImage:[UIImage resizedImage:@"common_button_red"] forState:UIControlStateNormal];
    [logoutButton setBackgroundImage:[UIImage resizedImage:@"common_button_red_highlighted"] forState:UIControlStateHighlighted];
