...
- (void)viewDidLoad
{
    ...
    self.tableView.sectionFooterHeight = MGStatusCellMargin; // 每一组的尾部高度
    ...
    if (iOS7) {
        self.tableView.contentInset = UIEdgeInsetsMake(MGStatusCellMargin - 33, 0, 0, 0);
    } else {
        self.tableView.contentInset = UIEdgeInsetsMake(MGStatusCellMargin, 0, 0, 0);
    }
}
